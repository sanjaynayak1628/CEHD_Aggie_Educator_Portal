...
urlpatterns = [
    ...
    path(
        'email/<str:super_email>/coop/<str:coop_email>/semester/<str:semester>/year/<str:year>/start/<str:start_date>/end/<str:end_date>',
        SupervisorCoopGet.as_view(), name='supervisor_coop_sem_dates_year'),

    path(
        'email/<str:super_email>/coop/<str:coop_email>/semester/<str:semester>/start/<str:start_date>/end/<str:end_date>',
        SupervisorCoopGet.as_view(), name='supervisor_coop_sem_dates'),

    path('email/<str:super_email>/coop/<str:coop_email>/year/<str:year>/start/<str:start_date>/end/<str:end_date>',
         SupervisorCoopGet.as_view(), name='supervisor_coop_year_dates'),
    ...
    path('email/<str:super_email>/coop/<str:coop_email>/year/<str:year>/start/<str:start_date>/end/<str:end_date>/export/<str:export>',
         SupervisorCoopGet.as_view(), name='supervisor_coop_year_dates_export'),
]
