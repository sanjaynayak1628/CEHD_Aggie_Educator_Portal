...
urlpatterns = [
    ...
    path('cooperatingteacher/view/email/<str:email>/start/<str:start_date>/end/<str:end_date>/status/<str:approved>/semester/<str:semester>/year/<str:year>', CoopViews.as_view(), name='coop_reload'),
